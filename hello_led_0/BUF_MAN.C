...
void direct_read(unsigned int *a_ptr)
{
 ...
 IOWR(ISP1362_BASE,HC_COMMAND_PORT,HcDirAddr_Port);
 ...
 cnt=0;
  do
   {
	*(a_ptr+cnt)=IORD(ISP1362_BASE,HC_DATA_PORT);
	cnt++;
   }
  while(cnt<2048);
}
...
void direct_write(unsigned int *w_ptr)
{
 ...
 IOWR(ISP1362_BASE,HC_COMMAND_PORT,HcDirAddr_Port|0x80);
...
void read_atl(unsigned int *a_ptr, unsigned int data_size)
{
 ...
 IOWR(ISP1362_BASE,HC_COMMAND_PORT,HcATL_Port);
...
void write_atl(unsigned int *a_ptr, unsigned int data_size)
{
 ...
 w16(HcTransferCnt,data_size*2);
 IOWR(ISP1362_BASE,HC_COMMAND_PORT,HcATL_Port|0x80);
...
void read_int(unsigned int *a_ptr, unsigned int data_size)
{
 ...
 w16(HcTransferCnt,data_size*2);
 IOWR(ISP1362_BASE,HC_COMMAND_PORT,HcInt_Port);
...
void write_int(unsigned int *a_ptr, unsigned int data_size)
{
 ...
 w16(HcTransferCnt,data_size*2);
 IOWR(ISP1362_BASE,HC_COMMAND_PORT,HcInt_Port|0x80);
